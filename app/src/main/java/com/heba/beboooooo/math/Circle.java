...
public class Circle extends AppCompatActivity {
    ...
    public void Relation(){
        ...
        newOp_btn.setBackground(getResources().getDrawable(R.drawable.btn1_cr));
    ...
    public void Result(){
        res_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (X_text.length() == 0 ) {
                    Toast toast = Toast.makeText(Circle.this, "please enter X value", Toast.LENGTH_SHORT);
                    toast.show();
                } else {
                    ...
                    res_txt.setText(String.valueOf(result));
                        ...
                        res_btn.setBackground(getResources().getDrawable(R.drawable.btn1_cr));


                        newOp_btn.setEnabled(true);
                        newOp_btn.setBackground(getResources().getDrawable(R.drawable.btn1));
                    ...
                    Toast toast = Toast.makeText(Circle.this,"Please Check First",Toast.LENGTH_SHORT);
                    toast.show();
                }
            }
        ...
        newOp_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                res_btn.setBackground(getResources().getDrawable(R.drawable.btn1));
            }
        });
